...
import { SOLIDITY_COURSE_ID, SOLIDITY_BASIC_LESSON_ID_2 } from '@site/src/constants/course';

# Solidity极简入门: 2. 数值类型

<QuizProgress courseId={SOLIDITY_COURSE_ID} lessonId={SOLIDITY_BASIC_LESSON_ID_2}></QuizProgress>
...
<QuizForm courseId={SOLIDITY_COURSE_ID} lessonId={SOLIDITY_BASIC_LESSON_ID_2}></QuizForm>