...
import { SOLIDITY_COURSE_ID, SOLIDITY_BASIC_LESSON_ID_3 } from '@site/src/constants/course';

# Solidity极简入门: 3. 函数类型

<QuizProgress courseId={SOLIDITY_COURSE_ID} lessonId={SOLIDITY_BASIC_LESSON_ID_3}></QuizProgress>
...
[SoLive](https://solive.wtf) 是第一个开源轻量级的Solidity集成开发环境，可轻松整合到网站、文档和教程中。由 WTF Academy 开发，受 Remix IDE 和 react-live 启发。
...
<QuizForm courseId={SOLIDITY_COURSE_ID} lessonId={SOLIDITY_BASIC_LESSON_ID_3}></QuizForm>