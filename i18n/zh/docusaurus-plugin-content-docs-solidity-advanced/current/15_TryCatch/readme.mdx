...
import { SOLIDITY_ADVANCED_ID, SOLIDITY_ADVANCED_LESSON_ID_15 } from '@site/src/constants/course';

# Solidity极简入门: 30. Try Catch
<QuizProgress courseId={SOLIDITY_ADVANCED_ID} lessonId={SOLIDITY_ADVANCED_LESSON_ID_15} />
...
<QuizForm courseId={SOLIDITY_ADVANCED_ID} lessonId={SOLIDITY_ADVANCED_LESSON_ID_15} />