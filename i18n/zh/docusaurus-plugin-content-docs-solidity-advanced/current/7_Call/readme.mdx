...
import { SOLIDITY_ADVANCED_ID, SOLIDITY_ADVANCED_LESSON_ID_7 } from '@site/src/constants/course';

# Solidity极简入门: 22. Call
<QuizProgress courseId={SOLIDITY_ADVANCED_ID} lessonId={SOLIDITY_ADVANCED_LESSON_ID_7} />
...
<QuizForm courseId={SOLIDITY_ADVANCED_ID} lessonId={SOLIDITY_ADVANCED_LESSON_ID_7} />