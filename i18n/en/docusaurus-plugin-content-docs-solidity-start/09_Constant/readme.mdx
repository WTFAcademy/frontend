...
import { SOLIDITY_COURSE_ID, SOLIDITY_BASIC_LESSON_ID_9 } from '@site/src/constants/course';

# WTF Solidity: 9. Constant and Immutable

<QuizProgress  courseId={SOLIDITY_COURSE_ID} lessonId={SOLIDITY_BASIC_LESSON_ID_9}></QuizProgress>
...
<QuizForm  courseId={SOLIDITY_COURSE_ID} lessonId={SOLIDITY_BASIC_LESSON_ID_9}></QuizForm>
