...
import { SOLIDITY_ADVANCED_ID, SOLIDITY_ADVANCED_LESSON_ID_5 } from '@site/src/constants/course';

# Solidity极简入门: 20. 发送ETH

<QuizProgress courseId={SOLIDITY_ADVANCED_ID} lessonId={SOLIDITY_ADVANCED_LESSON_ID_5} />
...
<QuizForm courseId={SOLIDITY_ADVANCED_ID} lessonId={SOLIDITY_ADVANCED_LESSON_ID_5} />
