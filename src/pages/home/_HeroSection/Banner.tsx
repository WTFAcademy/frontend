        ...
        <div className="bg-image h-[500px] w-full flex flex-col items-center justify-center bg-gray-200 text-white">
            ...
            <div className="rounded-full bg-[#251A12] h-10 flex gap-[10px] px-6 py-2 my-[42px] text-base">
                <div className="flex items-center gap-[10px]">
                    ...
                    <span className="font-medium text-[#EFDCCD]">Learn</span>
                </div>
                <div className="flex items-center gap-[10px]">
                    <span className="bg-[#C38E64] w-[3px] h-[3px] rounded-full" />
                    <span className="font-medium text-[#EFDCCD]">Contribute</span>
                </div>
                <div className="flex items-center gap-[10px]">
                    <span className="bg-[#C38E64] w-[3px] h-[3px] rounded-full" />
                    <span className="font-medium text-[#EFDCCD]">Get Certified</span>
                </div>
            </div>
