    ...
    <Tabs defaultValue="certificates" className="w-full">
      ...
      <TabsContent value="certificates">
        {certificates ? (
                ...
                item.finish_status == 2 && (
                  ...
                  >
                    ...
                    <div className="absolute z-10 flex flex-col items-start justify-end h-full p-3">
                      ...
                      <div className="flex items-center px-2 py-1 mt-2 overflow-hidden rounded-md bg-[#ffffff3f] backdrop-blur-[2px]">
                        <svg
                          width="12"
                          height="12"
                          viewBox="0 0 12 12"
                        ...
                        >
                          <path
                            d="M6 3.66667V6L7.75 7.75M11.25 6C11.25 8.8995 8.8995 11.25 6 11.25C3.10051 11.25 0.75 8.8995 0.75 6C0.75 3.10051 3.10051 0.75 6 0.75C8.8995 0.75 11.25 3.10051 11.25 6Z"
                            stroke="#F9FAFB"
                            strokeWidth="1.16667"
                            strokeLinecap="round"
                        ...
                        <p className="ml-1 text-xs text-white">
                          {new Date(item.course.updated_at)
                            .toISOString()
                            .split("T")[0] || "2023-03-03"}
                        </p>
                      </div>
                    </div>
                  </div>
          ...
          <Skeleton className="relative mt-8 bg-gray-200 w-[300px] h-[180px] rounded-xl">
            <div className="absolute z-10 flex flex-col items-start justify-end h-full p-3">
              <Skeleton className="bg-gray-300 w-[150px] h-[28px] rounded-md"></Skeleton>
              <Skeleton className="bg-gray-300 w-[150px] h-[16px] mt-0.5 rounded-md"></Skeleton>
              <Skeleton className="mt-2 bg-gray-300 w-[100px] h-[24px] rounded-md"></Skeleton>
            </div>
          </Skeleton>
        )}
      </TabsContent>
