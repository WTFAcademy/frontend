...
function PersonalAvatar() {
    ...
    return (
        <div className="flex items-center w-full px-8 mx-auto flex-col lg:w-[1024px] lg:flex-row lg:items-end">
            <div className="h-32 w-32 rounded-full bg-white -mt-[68px] flex-shrink-0 border-4 border-white box-content overflow-hidden lg:mr-5">
                {avatar ? 
