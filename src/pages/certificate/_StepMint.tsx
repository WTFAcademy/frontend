...
import {ArrowRightCircleIcon, InfoIcon, RedoIcon, RefreshCw, RefreshCwIcon} from "lucide-react";
...
const StepMint = (props) => {
    ...
    const {loading, error, mint, errorMessage, setError, setErrorMessage} = useMint(
        (tx) => {
            next({
                hash: tx.hash,
            ...
            <div className="flex flex-col w-full">
                <div className="flex items-center justify-between">
                    ...
                    {!loading && !error && active &&
                        <ArrowRightCircleIcon className="text-[24px] cursor-pointer" onClick={startMint}/>}
