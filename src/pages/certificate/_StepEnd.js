        ...
        <div className="flex flex-col mb-20">
            ...
            <div className="flex items-center mt-2">
                ...
                <div className="inline-flex text-[18px]">
                    <a className="inline-flex justify-center no-underline cursor-pointer item-center" target="_blank" href="https://www.instagram.com/">
                        <svg width="1em" height="1em" viewBox="0 0 106 106" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M80.7754 2.72461H25.0262C12.7105 2.72461 2.72656 12.7085 2.72656 25.0243V80.7735C2.72656 93.0893 12.7105 103.073 25.0262 103.073H80.7754C93.0913 103.073 103.075 93.0893 103.075 80.7735V25.0243C103.075 12.7085 93.0913 2.72461 80.7754 2.72461Z" fill="#333333" stroke="#333333" stroke-width="4" stroke-linejoin="round"/>
                            <path d="M52.8973 75.199C65.2132 75.199 75.197 65.2151 75.197 52.8993C75.197 40.5835 65.2132 30.5996 52.8973 30.5996C40.5815 30.5996 30.5977 40.5835 30.5977 52.8993C30.5977 65.2151 40.5815 75.199 52.8973 75.199Z" fill="white" stroke="white" stroke-width="4" stroke-linejoin="round"/>
                            <path d="M83.5593 27.8119C86.6383 27.8119 89.1342 25.3161 89.1342 22.237C89.1342 19.158 86.6383 16.6621 83.5593 16.6621C80.4803 16.6621 77.9844 19.158 77.9844 22.237C77.9844 25.3161 80.4803 27.8119 83.5593 27.8119Z" fill="white"/>
                        </svg>
                    </a>
                </div>
            </div>
