  ...
  return (
    <Controller
      ...
      render={({ field, fieldState: { error } }) => (
        <Form.Field
          className={cn("mb-[10px] grid", {
            "flex justify-between items-center gap-2": horizontal,
          })}
          name={name}
        >
          <div
          ...
          <Form.Control asChild>
            <Select
              {...field}
              onValueChange={e => handleChange(e, field)}
              {...other}
            >
              <SelectTrigger
                className={cn("w-full", {
                  "w-auto min-w-[100px] flex-shrink-0": horizontal,
                })}
              >
