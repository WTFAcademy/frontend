...
const ContributorList = () => {
  ...
  return isLoading ? (
    <Skeleton
      className={`h-[314px] w-[760px] rounded-md shadow-sm transition-shadow hover:shadow-lg px-4 flex flex-col justify-around`}
    >
      <Skeleton className="h-1/3 w-full bg-gray-200" />
      <Skeleton className="h-1/3 w-full bg-gray-200" />
    </Skeleton>
  ) : (
    <div className="border-border border rounded-md mx-auto">
