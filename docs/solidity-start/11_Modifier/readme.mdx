...
import { SOLIDITY_COURSE_ID, SOLIDITY_BASIC_LESSON_ID_11 } from '@site/src/constants/course';

# WTF Solidity Tutorial: 11. Constructor & Modifier

<QuizProgress courseId={SOLIDITY_COURSE_ID} lessonId={SOLIDITY_BASIC_LESSON_ID_11}></QuizProgress>
...
<QuizForm courseId={SOLIDITY_COURSE_ID} lessonId={SOLIDITY_BASIC_LESSON_ID_11}></QuizForm>
