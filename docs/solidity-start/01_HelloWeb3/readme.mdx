...
[SoLive](https://solive.wtf) SoLive is a flexible online playground for Solidity, which enables you to edit, compile, deploy, and interact with solidity smart contracts in one React component. Try it now!
...
<QuizForm courseId={SOLIDITY_COURSE_ID} lessonId={SOLIDITY_BASIC_LESSON_ID_1}></QuizForm>
