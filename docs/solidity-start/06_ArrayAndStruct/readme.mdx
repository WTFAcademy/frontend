...
import { SOLIDITY_COURSE_ID, SOLIDITY_BASIC_LESSON_ID_6 } from '@site/src/constants/course';

# Solidity极简入门: 6. 引用类型, array, struct

<QuizProgress courseId={SOLIDITY_COURSE_ID} lessonId={SOLIDITY_BASIC_LESSON_ID_6}></QuizProgress>
...
<QuizForm  courseId={SOLIDITY_COURSE_ID} lessonId={SOLIDITY_BASIC_LESSON_ID_6}></QuizForm>
