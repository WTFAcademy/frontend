...
import { SOLIDITY_COURSE_ID, SOLIDITY_BASIC_LESSON_ID_8 } from '@site/src/constants/course';

# WTF Solidity: 8. Initial Value

<QuizProgress courseId={SOLIDITY_COURSE_ID} lessonId={SOLIDITY_BASIC_LESSON_ID_8}></QuizProgress>
...
<QuizForm courseId={SOLIDITY_COURSE_ID} lessonId={SOLIDITY_BASIC_LESSON_ID_8}></QuizForm>
