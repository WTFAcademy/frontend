...
import { SOLIDITY_COURSE_ID, SOLIDITY_BASIC_LESSON_ID_13 } from '@site/src/constants/course';

# Solidity极简入门: 13. 继承

<QuizProgress courseId={SOLIDITY_COURSE_ID} lessonId={SOLIDITY_BASIC_LESSON_ID_13}></QuizProgress>
...
<QuizForm courseId={SOLIDITY_COURSE_ID} lessonId={SOLIDITY_BASIC_LESSON_ID_13}></QuizForm>
