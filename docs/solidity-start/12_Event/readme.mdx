...
import { SOLIDITY_COURSE_ID, SOLIDITY_BASIC_LESSON_ID_12 } from '@site/src/constants/course';

# WTF Solidity: 12. Events

<QuizProgress courseId={SOLIDITY_COURSE_ID} lessonId={SOLIDITY_BASIC_LESSON_ID_12}></QuizProgress>
...
<QuizForm courseId={SOLIDITY_COURSE_ID} lessonId={SOLIDITY_BASIC_LESSON_ID_12}></QuizForm>