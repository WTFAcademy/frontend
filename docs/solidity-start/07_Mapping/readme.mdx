...
import { SOLIDITY_COURSE_ID, SOLIDITY_BASIC_LESSON_ID_7 } from '@site/src/constants/course';

# Solidity极简入门: 7. 映射类型 mapping

<QuizProgress courseId={SOLIDITY_COURSE_ID} lessonId={SOLIDITY_BASIC_LESSON_ID_7}></QuizProgress>
...
<QuizForm courseId={SOLIDITY_COURSE_ID} lessonId={SOLIDITY_BASIC_LESSON_ID_7}></QuizForm>
