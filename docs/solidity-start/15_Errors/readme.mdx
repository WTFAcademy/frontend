...
import { SOLIDITY_COURSE_ID, SOLIDITY_BASIC_LESSON_ID_15 } from '@site/src/constants/course';

# Solidity极简入门: 15. 异常

<QuizProgress courseId={SOLIDITY_COURSE_ID} lessonId={SOLIDITY_BASIC_LESSON_ID_15}></QuizProgress>
...
<QuizForm courseId={SOLIDITY_COURSE_ID} lessonId={SOLIDITY_BASIC_LESSON_ID_15}></QuizForm>