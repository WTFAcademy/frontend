...
import { SOLIDITY_COURSE_ID, SOLIDITY_BASIC_LESSON_ID_5 } from '@site/src/constants/course';

# WTF Solidity Tutorial: 5. Data Storage and Scope

<QuizProgress courseId={SOLIDITY_COURSE_ID} lessonId={SOLIDITY_BASIC_LESSON_ID_5}></QuizProgress>
...
All codebase and tutorial notes are open source and available on GitHub (At 1024 repo stars, course certificates is unlocked. At 2048 repo stars, community NFT is unlocked.): [github.com/AmazingAng/WTFSolidity](https://github.com/AmazingAng/WTFSolidity)\
...
<QuizForm courseId={SOLIDITY_COURSE_ID} lessonId={SOLIDITY_BASIC_LESSON_ID_5}></QuizForm>