...
import { SOLIDITY_COURSE_ID, SOLIDITY_BASIC_LESSON_ID_4 } from '@site/src/constants/course';

# WTF Solidity Tutorial: 4. Function Output (return/returns)

<QuizProgress courseId={SOLIDITY_COURSE_ID} lessonId={SOLIDITY_BASIC_LESSON_ID_4}></QuizProgress>
...
<QuizForm courseId={SOLIDITY_COURSE_ID} lessonId={SOLIDITY_BASIC_LESSON_ID_4}></QuizForm>
