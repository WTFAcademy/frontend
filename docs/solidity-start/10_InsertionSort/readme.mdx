...
import { SOLIDITY_COURSE_ID, SOLIDITY_BASIC_LESSON_ID_10 } from '@site/src/constants/course';

# WTF Solidity Tutorial: 10. Control Flow

<QuizProgress courseId={SOLIDITY_COURSE_ID} lessonId={SOLIDITY_BASIC_LESSON_ID_10}></QuizProgress>
...
<QuizForm courseId={SOLIDITY_COURSE_ID} lessonId={SOLIDITY_BASIC_LESSON_ID_10}></QuizForm>
