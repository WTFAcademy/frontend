...
import { SOLIDITY_ADVANCED_LESSON_ID_14 } from '@site/src/constants/course';

# Solidity极简入门: 29. 函数选择器Selector
<QuizProgress lessonId={SOLIDITY_ADVANCED_LESSON_ID_14} />
...
<QuizForm lessonId={SOLIDITY_ADVANCED_LESSON_ID_14} />