...
import { SOLIDITY_ADVANCED_LESSON_ID_2 } from '@site/src/constants/course';

# Solidity极简入门: 2. 库合约 站在巨人的肩膀上

<QuizProgress lessonId={SOLIDITY_ADVANCED_LESSON_ID_2}></QuizProgress>
...
<QuizForm lessonId={SOLIDITY_ADVANCED_LESSON_ID_2}></QuizForm>
