...
import { SOLIDITY_ADVANCED_LESSON_ID_10 } from '@site/src/constants/course';

# Solidity极简入门: 10. Create2
<QuizProgress lessonId={SOLIDITY_ADVANCED_LESSON_ID_10} />
...
<QuizForm lessonId={SOLIDITY_ADVANCED_LESSON_ID_10} />