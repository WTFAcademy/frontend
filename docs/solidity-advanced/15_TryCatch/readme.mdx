...
import { SOLIDITY_ADVANCED_LESSON_ID_15 } from '@site/src/constants/course';

# Solidity极简入门: 30. Try Catch
<QuizProgress lessonId={SOLIDITY_ADVANCED_LESSON_ID_15} />
...
<QuizForm lessonId={SOLIDITY_ADVANCED_LESSON_ID_15} />