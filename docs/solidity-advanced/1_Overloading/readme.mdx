...
import { SOLIDITY_ADVANCED_LESSON_ID_1 } from '@site/src/constants/course';

# Solidity极简入门: 16. 函数重载

<QuizProgress lessonId={SOLIDITY_ADVANCED_LESSON_ID_1}></QuizProgress>
...
<QuizForm lessonId={SOLIDITY_ADVANCED_LESSON_ID_1}></QuizForm>
