...
import { SOLIDITY_ADVANCED_LESSON_ID_12 } from '@site/src/constants/course';

# Solidity极简入门: 12. ABI编码解码
<QuizProgress lesson={SOLIDITY_ADVANCED_LESSON_ID_12} />
...
<QuizForm lessonId={SOLIDITY_ADVANCED_LESSON_ID_12} />