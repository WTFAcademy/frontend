...
import { SOLIDITY_ADVANCED_ID, SOLIDITY_ADVANCED_LESSON_ID_12 } from '@site/src/constants/course';

# Solidity极简入门: 27. ABI编码解码
<QuizProgress courseId={SOLIDITY_ADVANCED_ID} lessonId={SOLIDITY_ADVANCED_LESSON_ID_12} />
...
<QuizForm courseId={SOLIDITY_ADVANCED_ID} lessonId={SOLIDITY_ADVANCED_LESSON_ID_12} />