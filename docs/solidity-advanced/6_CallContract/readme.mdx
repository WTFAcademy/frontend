...
import { SOLIDITY_ADVANCED_LESSON_ID_6 } from '@site/src/constants/course';

# Solidity极简入门: 6. 调用其他合约
<QuizProgress lessonId={SOLIDITY_ADVANCED_LESSON_ID_6} />
...
<QuizForm lessonId={SOLIDITY_ADVANCED_LESSON_ID_6} />