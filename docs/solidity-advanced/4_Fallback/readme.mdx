...
import { SOLIDITY_ADVANCED_LESSON_ID_4 } from '@site/src/constants/course';

# Solidity极简入门: 4. 接收ETH receive和fallback

<QuizProgress lessonId={SOLIDITY_ADVANCED_LESSON_ID_4} />
...
<QuizForm lessonId={SOLIDITY_ADVANCED_LESSON_ID_4} />