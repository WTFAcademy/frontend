...
import { SOLIDITY_ADVANCED_LESSON_ID_8 } from '@site/src/constants/course';

# Solidity极简入门: 8. Delegatecall
<QuizProgress lessonId={SOLIDITY_ADVANCED_LESSON_ID_8} />
...
<QuizForm lessonId={SOLIDITY_ADVANCED_LESSON_ID_8} />
