...
import { SOLIDITY_ADVANCED_ID, SOLIDITY_ADVANCED_LESSON_ID_13 } from '@site/src/constants/course';

# Solidity极简入门: 28. Hash
<QuizProgress courseId={SOLIDITY_ADVANCED_ID} lessonId={SOLIDITY_ADVANCED_LESSON_ID_13} />
...
<QuizForm courseId={SOLIDITY_ADVANCED_ID} lessonId={SOLIDITY_ADVANCED_LESSON_ID_13} />