...
import { SOLIDITY_ADVANCED_LESSON_ID_13 } from '@site/src/constants/course';

# Solidity极简入门: 13. Hash
<QuizProgress lessonId={SOLIDITY_ADVANCED_LESSON_ID_13} />
...
<QuizForm lessonId={SOLIDITY_ADVANCED_LESSON_ID_13} />