...
import { SOLIDITY_ADVANCED_LESSON_ID_5 } from '@site/src/constants/course';

# Solidity极简入门: 5. 发送ETH

<QuizProgress lessonId={SOLIDITY_ADVANCED_LESSON_ID_5} />
...
<QuizForm lessonId={SOLIDITY_ADVANCED_LESSON_ID_5} />
