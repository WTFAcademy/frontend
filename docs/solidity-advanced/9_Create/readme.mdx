...
import { SOLIDITY_ADVANCED_LESSON_ID_9 } from '@site/src/constants/course';

# Solidity极简入门: 9. 在合约中创建新合约
<QuizProgress lessonId={SOLIDITY_ADVANCED_LESSON_ID_9} />
...
<QuizForm lessonId={SOLIDITY_ADVANCED_LESSON_ID_9} />