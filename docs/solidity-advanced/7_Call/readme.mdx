...
import { SOLIDITY_ADVANCED_LESSON_ID_7 } from '@site/src/constants/course';

# Solidity极简入门: 22. Call
<QuizProgress lessonId={SOLIDITY_ADVANCED_LESSON_ID_7} />
...
<QuizForm lessonId={SOLIDITY_ADVANCED_LESSON_ID_7} />