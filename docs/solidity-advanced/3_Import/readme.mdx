...
import { SOLIDITY_ADVANCED_LESSON_ID_3 } from '@site/src/constants/course';

# Solidity极简入门: 3. Import

<QuizProgress lessonId={SOLIDITY_ADVANCED_LESSON_ID_3}></QuizProgress>
...
<QuizForm lessonId={SOLIDITY_ADVANCED_LESSON_ID_3} />
