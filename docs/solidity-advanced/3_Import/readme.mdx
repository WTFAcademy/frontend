...
import { SOLIDITY_ADVANCED_ID,SOLIDITY_ADVANCED_LESSON_ID_3 } from '@site/src/constants/course';

# Solidity极简入门: 18. Import

<QuizProgress courseId={SOLIDITY_ADVANCED_ID} lessonId={SOLIDITY_ADVANCED_LESSON_ID_3}></QuizProgress>
...
<QuizForm courseId={SOLIDITY_ADVANCED_ID} lessonId={SOLIDITY_ADVANCED_LESSON_ID_3} />
