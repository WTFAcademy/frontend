...
import { SOLIDITY_ADVANCED_LESSON_ID_11 } from '@site/src/constants/course';

# Solidity极简入门: 11. 删除合约
<QuizProgress lessonId={SOLIDITY_ADVANCED_LESSON_ID_11} />
...
<QuizForm lessonId={SOLIDITY_ADVANCED_LESSON_ID_11} />